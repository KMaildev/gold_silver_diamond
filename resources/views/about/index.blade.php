...
@section('content')
    ...
    <div class="section-full p-t120 site-bg-white twm-our-comu-hpage-6-area"
        style="background-image: url({{ asset('data/bagan.jpg') }});">
        <div class="container">
                ...
                <div class="row wt-separator-two-part-row">
                    <div class="col-xl-8 col-lg-8 col-md-12 wt-separator-two-part-left">
                        <div class="section-head left wt-small-separator-outer">
                            ...
                            <h2 class="wt-title">
                                We are ready to deliver foreign workers to employers
                        ...
                        <div class="row">
                                ...
                                <div class="counter-outer-two">
                                    ...
                                    <div class="icon-content">
                                        <div class="tw-count-number site-text-white">
                                            <span class="counter text-clr-green">
                                                5000
                                            </span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="counter-outer-two">
                                    ...
                                    <div class="icon-content">
                                        <div class="tw-count-number site-text-white">
                                            <span class="counter text-clr-pink">4</span>
                                        </div>
                                        <p class="icon-content-info">
                                            Sending Countries
                                        </p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="counter-outer-two">
                                    ...
                                    <div class="icon-content">
                                        <div class="tw-count-number site-text-white">
                                            <span class="counter text-clr-yellow-2">
                                                800
                                            </span>
                                        </div>
                                        <p class="icon-content-info">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="counter-outer-two">
                                    ...
                                    <div class="icon-content">
                                        <div class="tw-count-number site-text-white">
                                            <span class="counter text-clr-purple">10</span>
                                        </div>
                                        <p class="icon-content-info">
                                            Our Experience
                                        </p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="twm-w-process-steps-2">
                                    <div class="twm-w-pro-top bg-clr-pink-light bg-pink-light-shadow">
                                        ...
                                        <div class="twm-media">
                                            <span>
                                                <img src="{{ asset('assets/images/work-process/icon3.png') }}"
                                                    alt="icon1">
                                            </span>
                                        </div>
